...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="Mnist-alpha0.1-ratio0.1")
    parser.add_argument("--algorithms", type=str, default="FedAvg", help='algorithm names separate by comma')
