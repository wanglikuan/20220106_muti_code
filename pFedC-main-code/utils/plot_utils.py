...
def plot_results(args, algorithms):
    ...
    fig_save_path = os.path.join('figs', sub_dir)
    if not os.path.exists(fig_save_path):
        os.makedirs(fig_save_path)
    plt.savefig(os.path.join(fig_save_path, dataset_[0] + '-' + dataset_[2] + '.png'), bbox_inches='tight', pad_inches=0, format='png', dpi=400)
    plt.show()
